...
export const athleteCategory = (age, gender, weight) => {
  ...
  if (age >= 14 && age <= 18) {
    ...
    if ((gender === 'male' && weight >= 54 && weight <= 59) ||
        (gender === 'female' && weight >= 44 && weight <= 47)) {
      return 'Junior';
    }
  } 
  else if (age >= 24 && age <= 39) {
    if ((gender === 'male' && weight >= 60 && weight <= 66) ||
        (gender === 'female' && weight >= 48 && weight <= 52)) {
      return 'Senior';
    }
  } 
  else if (age >= 40 && age <= 49) {
    if ((gender === 'male' && weight >= 67 && weight <= 74) ||
        (gender === 'female' && weight >= 53 && weight <= 57)) {
      return 'Master 1';
    }
  } 
  else if (age >= 50 && age <= 59) {
    if ((gender === 'male' && weight >= 75 && weight <= 83) ||
        (gender === 'female' && weight >= 58 && weight <= 63)) {
      return 'Master 2';
    }
  } 
  else if (age >= 60 && age <= 69) {
    if ((gender === 'male' && weight >= 84 && weight <= 93) ||
        (gender === 'female' && weight >= 64 && weight <= 69)) {
      return 'Master 3';
    }
  } 
  else if (age >= 70 && age <= 79) {
    if ((gender === 'male' && weight >= 94 && weight <= 105) ||
        (gender === 'female' && weight >= 70 && weight <= 76)) {
      return 'Master 4';
    }
  } 
  else if (age >= 80 && age <= 99) {
    if ((gender === 'male' && weight >= 106) ||
        (gender === 'female' && weight >= 77)) {
      return 'Master 5';
    }
  }
